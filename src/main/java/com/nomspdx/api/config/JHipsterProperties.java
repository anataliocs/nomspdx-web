...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "nomspdx@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "nomspdx API";

        private String description = "nomspdx API documentation";
